...
public class LocationHelper implements com.google.android.gms.location.LocationListener,
    ...
    public LocationHelper(Context context) {
        ...
        LocationRequest.Builder builder = new LocationRequest.Builder(UPDATE_INTERVAL);
        // Use high accuracy
        builder.setPriority(Priority.PRIORITY_HIGH_ACCURACY);
        // Set the update interval to 5 seconds
        builder.setIntervalMillis(UPDATE_INTERVAL);
        // Set the fastest update interval to 1 second
        builder.setMinUpdateIntervalMillis(FASTEST_INTERVAL);
    ...
    public LocationHelper(Context context, int interval) {
        mContext = context;
        UPDATE_INTERVAL = (long) interval * MILLISECONDS_PER_SECOND;
        mLocationManager = (LocationManager) Application.get().getBaseContext()
                .getSystemService(Context.LOCATION_SERVICE);
