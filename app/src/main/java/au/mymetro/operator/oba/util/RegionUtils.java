...
public class RegionUtils {
    ...
    public static ArrayList<ObaRegion> getRegionsFromProvider(Context context) {
        ...
        try {
            final String[] PROJECTION = {
                    ...
                    ObaContract.Regions.TRACCAR_BASE_URL,
            };
    ...
    public static ArrayList<ObaRegion> getRegionsFromResources(Context context) {
        ...
        builder.path(Integer.toString(R.raw.regions_v5));
    ...
    */
    ...
    private static ContentValues toContentValues(ObaRegion region) {
        ...
        values.put(ObaContract.Regions.TRACCAR_BASE_URL, region.getTraccarBaseUrl());
        return values;
    }
    ...
    public synchronized static boolean isApiKeyValid(Context context) {
        ObaCurrentTimeResponse response = ObaCurrentTimeRequest.newRequest(context).call();
    ...
    public synchronized static boolean isApiKeyValid(Context context, String newApiKey) {
        String oldApiKey = ObaContext.getApiKey();
        ObaContext.setApiKey(newApiKey);
        ObaCurrentTimeResponse response = ObaCurrentTimeRequest.newRequest(context).call();
        ObaContext.setApiKey(oldApiKey);
        if (response.getCode() != 200) {
            return false;
        }
