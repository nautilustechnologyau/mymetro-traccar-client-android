 ...
 */
package au.mymetro.operator.oba.provider;
...
import au.mymetro.operator.oba.model.PathLink;
...
public final class ObaContract {
    ...
    protected interface RegionsColumns {
        ...
        /**
         * The Traccar base URL for the region
         * <P>
         * Type: TEXT
         * </P>
         */
        public static final String TRACCAR_BASE_URL = "traccar_base_url";
    }
    ...
    public static class Stops implements BaseColumns, StopsColumns, UserColumns {
        ...
        public static boolean markAsFavorite(Context context,
            ...
            values.put(Stops.FAVORITE, favorite ? 1 : 0);
        ...
        public static boolean markAsUnused(Context context, Uri uri) {
            ContentResolver cr = context.getContentResolver();
            ContentValues values = new ContentValues();
            values.put(Stops.USE_COUNT, 0);
            values.putNull(Stops.ACCESS_TIME);
            return cr.update(uri, values, null, null) > 0;
        }
    ...
    public static class Routes implements BaseColumns, RoutesColumns,
        ...
        public static boolean markAsFavorite(Context context,
            ...
            ContentResolver cr = context.getContentResolver();
            ContentValues values = new ContentValues();
            values.put(Routes.FAVORITE, favorite ? 1 : 0);
            return cr.update(uri, values, null, null) > 0;
        }
        ...
        public static boolean markAsUnused(Context context, Uri uri) {
            ContentResolver cr = context.getContentResolver();
            ContentValues values = new ContentValues();
            values.put(Routes.USE_COUNT, 0);
            values.putNull(Routes.ACCESS_TIME);
            return cr.update(uri, values, null, null) > 0;
        }
        ...
        public static boolean isFavorite(Context context, Uri routeUri) {
            ContentResolver cr = context.getContentResolver();
            String[] ROUTE_USER_PROJECTION = {Routes.FAVORITE};
    ...
    public static class Trips implements BaseColumns, StopRouteKeyColumns,
        ...
        public static boolean[] daysToArray(int days) {
            final boolean[] result = {
                    (days & Trips.DAY_MON) == Trips.DAY_MON,
                    (days & Trips.DAY_TUE) == Trips.DAY_TUE,
                    (days & Trips.DAY_WED) == Trips.DAY_WED,
                    (days & Trips.DAY_THU) == Trips.DAY_THU,
                    (days & Trips.DAY_FRI) == Trips.DAY_FRI,
                    (days & Trips.DAY_SAT) == Trips.DAY_SAT,
                    (days & Trips.DAY_SUN) == Trips.DAY_SUN,};
            return result;
        }
        ...
        public static int getDayBit(int weekday) {
            switch (weekday) {
                case Time.MONDAY:
                    return Trips.DAY_MON;
                case Time.TUESDAY:
                    return Trips.DAY_TUE;
                case Time.WEDNESDAY:
                    return Trips.DAY_WED;
                case Time.THURSDAY:
                    return Trips.DAY_THU;
                case Time.FRIDAY:
                    return Trips.DAY_FRI;
                case Time.SATURDAY:
                    return Trips.DAY_SAT;
                case Time.SUNDAY:
                    return Trips.DAY_SUN;
            }
            return 0;
        }
    }
            ...
            if (c != null) {
                try {
                    ...
                    return new ObaRegionElement(id,   // id
                            ...
                            c.getString(21) // Traccar base URL
                    );
                } finally {
                    c.close();
                }
    ...
    public static class RouteHeadsignFavorites implements RouteHeadsignKeyColumns, UserColumns {
        ...
        public static void markAsFavorite(Context context, String routeId, String headsign, String
            ...
            ContentResolver cr = context.getContentResolver();
            Uri routeUri = Uri.withAppendedPath(Routes.CONTENT_URI, routeId);
